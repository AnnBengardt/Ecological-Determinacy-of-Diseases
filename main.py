...
def analysis_results():
    ...
    with st.expander("Сбор данных"):
        st.write("---")
        st.write("""Сбор данных о заболеваемости населения социально значимыми болезнями в Москве происходил путём массового анкетирования онлайн.
        Несколько графиков по ответам респондентов:""")
        for i in range(1,4):
...
def ecorating():
    ...
    st.write("•	От 0 до 100 – отлично (около 21% районов на данный момент), зелёный цвет на карте;")
    st.write("•	От 100 до 200 – хорошо (около 21% районов на данный момент), жёлтый цвет на карте;")
    st.write("•	От 200 до 300 – удовлетворительно (около 30% районов на данный момент), оранжевый цвет на карте;")
    st.write("•	От 300 до 400 – неудовлетворительно (около 18% районов на данный момент), красный цвет на карте;")
    st.write("•	От 400 и более – плохо (около 10% районов на данный момент), бордовый цвет на карте.")
    st.write("---")
...
def main():
    ...
    st.header('ИСПОЛЬЗОВАНИЕ МЕТОДОВ МАШИННОГО ОБУЧЕНИЯ ПРИ ИССЛЕДОВАНИИ ЭКОЛОГИЧЕСКОЙ ДЕТЕРМИНИРОВАННОСТИ СОЦИАЛЬНО ЗНАЧИМЫХ ЗАБОЛЕВАНИЙ В Г. МОСКВЕ')
